...
var getRandomUserAgent = /* @__PURE__ */ __name(() => {
  return USER_AGENTS[Math.floor(Math.random() * USER_AGENTS.length)];
}, "getRandomUserAgent");
async function fetchWithProxy(targetUrl, init = {}, proxyUrl) {
...
__name(fetchWithProxy, "fetchWithProxy");
var corsMiddleware = /* @__PURE__ */ __name((origin) => {
  ...
  return c.json(
    {
      ...
      ...typeof process !== "undefined" && true && { stack: errorStack }
    },
    500
  );
});
...
app.get("/fetch-metadata", async (c) => {
  ...
  try {
    ...
    const parseDuration = /* @__PURE__ */ __name((duration) => {
      ...
      if (!match2) return 0;
      const hours = (parseInt(match2[1] || "0") || 0) * 3600;
      const minutes = (parseInt(match2[2] || "0") || 0) * 60;
      const seconds = parseInt(match2[3] || "0") || 0;
      return hours + minutes + seconds;
    }, "parseDuration");
    const getThumbnailUrl = /* @__PURE__ */ __name((thumbnails) => {
...
app.post("/fetch-transcript", async (c) => {
  ...
  try {
    ...
    const transcriptTimeout = setTimeout(() => transcriptController.abort(), 5e3);
    ...
    const captionData = await transcriptResponse.json();
    ...
    const transcript = captionData.events.filter((event) => event && Array.isArray(event.segs) && event.segs.length > 0).map((event) => {
...
// ../node_modules/.pnpm/wrangler@4.94.0_@cloudflare+workers-types@4.20260522.1/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@4.94.0_@cloudflare+workers-types@4.20260522.1/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-88w5ag/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@4.94.0_@cloudflare+workers-types@4.20260522.1/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-88w5ag/middleware-loader.entry.ts
