# Live TODO — session 2026-09-24 (updated every round)
...
- [~] 5. ADR 032 — S1 PASS (≤0.7 MB/chunk) · S3 FAIL (tee+collect 11–63 ms CPU) · S2 running · proposed S4 (Vercel per-chunk streaming under Fluid 300 s) → revised ADR. Revision must also: add Alternatives + Confirmed-by-user to .memory/ADRS.md entry, say browser keeps live SSE parsing, fill ADR table gap 025–031 (#329 review)
...
- [ ] Billing follow-ups from triage: delete legacy /api/billing/webhook (hardcodes tier 'pro'), Redis SETNX lock on Paddle webhook, Sentry in ProcessPaddleWebhookUseCase catch, fix stale Dodo header in pricing.ts
...
- OC GLM: #320 review round · #326 round 2 · spikes S1/S2/S3
- OC Spark: payments triage
- CI: #330 (job A), #329 (ADR 032 docs)
