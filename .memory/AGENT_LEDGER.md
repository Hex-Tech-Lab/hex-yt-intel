...
- [2026-07-27T20:00:00Z] [AGY (Gemini)] [DONE] Deep RCA & Fix: Comprehensive refactor of EVERY remaining .filter call across web/components/ and web/hooks/ (useKnowledgeGraph, GlobalKnowledgeMap, MindMap, WordCloud, StreamingGrid, TimestampLink, ExecutiveDigestCard, useSearch) to explicit for-of loops. 100% of client-side array filter callbacks eliminated, permanently preventing SWC/Turbopack scope-mangling TDZ crashes on Knowledge Graph and component rendering.
