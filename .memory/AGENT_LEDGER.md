...
- [2026-06-11T19:26:00+03:00] [Antigravity (Agent)] [DONE] Implemented dynamic cross-domain OAuth redirect callback bouncer in form.tsx and route.ts, resolving Google Auth redirects jumping to production from preview URLs. Staged, committed, and force-deployed preview branch feature/1.6.0-prompts-and-limits to Vercel.
