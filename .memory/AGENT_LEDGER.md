...
- [2026-06-11T00:20:00+03:00] [Antigravity (Agent)] [DONE] Decoupled Chat cascade from Analysis cascade, setting google/gemini-3.1-flash-lite as the primary chat model for high-throughput, low-latency, and dialect-capable interactions.
