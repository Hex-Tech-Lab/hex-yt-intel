...
- [2026-08-06T15:00:00+03:00] [OC (opencode/DeepSeek)] [IN_PROGRESS] Chapters decoupling from analysis lifecycle (feat/chapters-decoupling). Tasks: (1) new POST /api/videos/[videoId]/chapters endpoint with HMAC auth, (2) worker parseChapters fires at metadata resolution time via waitUntil, (3) new useChaptersStore Zustand store, (4) safety-net removal deferred after E2E proof. Reading existing HMAC/verifyContentSig/waitUntil patterns now.
