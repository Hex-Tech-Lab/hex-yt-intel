...
async def run_test():
    ...
    try:
        ...
        # -> Fill '<test-account email from TESTSPRITE_TEST_ACCOUNT_EMAIL>' into the Email field, fill '<test-account password from TESTSPRITE_TEST_ACCOUNT_PASSWORD>' into the Password field, then click the 'Sign in with test account' button.
        # email email field
