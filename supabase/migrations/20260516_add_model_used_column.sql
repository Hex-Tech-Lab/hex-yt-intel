...
COMMENT ON COLUMN public.analyses.model_used IS 'The OpenRouter model identifier used to generate this analysis (e.g., anthropic/claude-haiku-4.5, anthropic/claude-3.5-haiku)';
