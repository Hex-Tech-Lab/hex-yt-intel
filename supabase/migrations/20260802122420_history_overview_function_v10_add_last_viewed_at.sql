-- History overview v10 -- surface last_viewed_at (max across the group,
-- same aggregation shape as last_analyzed_at) now that
-- increment_analysis_view sets it on every open.
