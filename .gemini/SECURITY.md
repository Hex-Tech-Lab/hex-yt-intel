...
_This file is read by Gemini agents on every session start._
...
1. Audit `.env*` files and `docs/specs/` for real values
2. Replace any found secrets with `PLACEHOLDER_*_KEEP_LOCAL` markers
3. Document the finding and request admin unblock
