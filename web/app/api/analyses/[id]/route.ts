...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json({
      id: analysis.id,
      // Without stripping, a restored analysis's raw video_id (e.g.
      // 'vEC6e5dBi4Y_archived_1784...') gets handed straight to the YouTube
      // player, which rejects it as invalid and can cascade into a React
      // DOM crash from the resulting failed-mount re-render.
      videoId: stripArchivedVideoIdSuffix(analysis.video_id) ?? null,
