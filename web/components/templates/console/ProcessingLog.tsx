...
import { IconButton, StatusDot, Divider } from '@astryxdesign/core';
...
export function ProcessingLog({ status }: ProcessingLogProps) {
  ...
  return (
    <div className="border border-[var(--line)] rounded-xl overflow-hidden bg-[rgb(11_14_20_/_0.96)] backdrop-blur-md shadow-[0_4px_20px_-5px_rgba(0,0,0,0.5)]">
      <div className="flex items-center justify-between px-3.5 py-2 bg-[rgb(26_31_43_/_0.7)]">
        ...
        <div className="flex items-center gap-2.5">
          ...
          />
          <IconButton
            label={collapsed ? 'Expand processing log' : 'Collapse processing log'}
            variant="ghost"
            size="sm"
            icon={<Icon icon={collapsed ? 'solar:alt-arrow-up-linear' : 'solar:alt-arrow-down-linear'} size={12} />}
