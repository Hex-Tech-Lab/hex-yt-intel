...
describe("UCISValidator", () => {
    ...
    dimensions: [
      {
        ...
        content: "Apex summary content here",
      },
      {
        number: 2,
        name: "Provenance & Metadata",
        content: "Provenance content here",
      },
      {
        number: 3,
        name: "Content Architecture",
        content: "Content architecture content here",
      },
      {
        number: 4,
        name: "Psychological Layer",
        content: "Psychological layer content here",
      },
      {
        number: 5,
        name: "Core Intelligence",
        content: "Core intelligence content here",
      },
      {
        number: 6,
        name: "Comparative & Quantitative",
        content: "Comparative content here",
      },
      {
        number: 7,
        name: "Implementation Systems",
        content: "Implementation content here",
      },
      {
        number: 8,
      ...
      },
      {
        ...
        content: "Forward intelligence content here",
      },
      {
        number: 10,
        name: "Credibility & Meta-Assessment",
        content: "Credibility content here",
      },
      {
        number: 11,
        name: "Commercial Yield",
        content: "Monetization content here",
      },
    ],
    knowledgeGraph: {
      nodes: [
        {
          ...
          dimension: 8,
          label: "Node 1",
          content: "Domain node content here",
          weight: 0.8,
          polarity: 1,
          keyTerms: ["term1"],
          entityType: "concept",
  ...
  describe("Contract Validation via UCISValidator.validate", () => {
    it("should pass validation for a fully compliant v2.0 JSON payload", () => {
      const report = UCISValidator.validate(
        validV2Payload,
        "test-video-2026-07-27.md",
      );
      if (!report.passed) {
        console.log(
          "Test Failed Checks:",
