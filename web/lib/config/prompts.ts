...
export const CHAT_PROTOCOL = [
  ...
  '4) LENGTH: For questions, answer in at most 5 short bullet points (or 2-3 sentences), no headings or tables, substance first. For repurposing requests (rule 2), length and structure follow the requested format instead — a podcast script or blog post may be as long as the format needs.',
