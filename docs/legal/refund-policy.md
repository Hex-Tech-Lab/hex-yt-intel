...
- **Demonstrable Technical Failures:** If a systemic bug or prolonged server outage entirely prevents you from generating summaries.
- **Billing Errors:** If you are charged multiple times for a single transaction due to a payment gateway error.

To request a review for service credits, you must contact support with documented evidence (e.g., error logs, timestamps, or screenshots) within 7 days of the incident.

## 5. Free Tier and Trials
We provide a free tier so that all users can evaluate the accuracy, latency, and quality of our AI summaries before committing to a paid plan. By upgrading to a paid subscription, you acknowledge that the Service meets your expectations.
