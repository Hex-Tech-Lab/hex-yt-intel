...
- **Multi-model fallback**: Automatically cycles through a prioritized list of models (Nemotron, GLM, Gemma, Claude) to ensure reliable output even if specific providers fail or are rate-limited.
