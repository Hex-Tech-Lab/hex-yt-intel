> **Historical note (PR #324 review, 2026-09-24):** the `UserTier` importer list below was hand-written and partly wrong (it omitted `ProcessChatMessageUseCase.ts`, which defines `Record<UserTier, number>`). The round-2 prompt (`2026-09-24-oc-tier-step1-round2.md`) requires a generated consumer list instead.
