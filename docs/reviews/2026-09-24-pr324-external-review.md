...
- P0 Netlify failing (free-plan concurrent builds).
...
- P2 A/B/D prompts bundle measure+fix+verify; B lacked an idempotency contract before dedupe.
- P3 dated status docs need as-of/owner/expiry.
