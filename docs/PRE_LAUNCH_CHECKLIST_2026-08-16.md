...
- A parallel OC/GLM-5.3-flash-low dispatch is independently gathering raw evidence for the remaining §3/§5/§6b/§7 items (waitlist page liveness, GDPR footnote, load tests, TestSprite re-run) — results land in `docs/PRE_LAUNCH_AUDIT_RAW_2026-09-10.md` once it completes; this document will get a second pass once that lands.
