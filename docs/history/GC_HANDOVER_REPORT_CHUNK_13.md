...
To prevent multi-agent folder pollution, **only 3 Markdown files are permitted in the root**: `CLAUDE.md`, `GEMINI.md`, and `README.md`. Everything else MUST be routed to `/docs/`.
