...
**Version**: `1.2.0`  
**Build**: `d903d12`  
**Timestamp**: `2026-07-01T12:53:00+03:00`  
**Purpose**: Document stabilization fixes for the knowledge graph, word cloud, details drawer, worker validation, history restoration query, and history chat grounding state.

---

## 1. Summary of Changes

### 1.1 History Restoration Chat Grounding & State Leakage
- **Root Cause**: 
...
### 1.2 History Restoration (HTTP 500 Fix)
